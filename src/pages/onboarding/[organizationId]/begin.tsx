...
export default function OrganizationOnboarding() {
    ...
    return (
        <div className="flex flex-row items-center h-[100vh]">
            ...
            {/* Right view */}
            <div className="flex flex-col flex-1 bg-[#00000005] h-full px-6 pt-12 overflow-y-auto">
                <div>
